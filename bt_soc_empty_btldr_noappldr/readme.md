...
Note that Example Projects do not include a bootloader. However, Bluetooth-based Example Projects expect a bootloader to be present on the device in order to support device firmware upgrade (DFU). To get your application to work, you should flash the proper bootloader.
...
- Create a bootloader project, build it and flash it to your device. Note that different projects expect different bootloaders:
  ...
  - for SoC projects on Series 2 devices create a *Bluetooth in-place OTA DFU* type bootloader or any *Internal Storage* type bootloader
...
- On Series 2 devices SoC example projects require a *Bluetooth in-place OTA DFU* type bootloader by default.
